...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/shop$1.0.0/server/views/productDetails.marko",
...
function render(input, out, __component, component, state) {
  ...
  marko_forEach(data.products, function(item) {
    ...
    out.w("<div class=\"col-md-12\"><div class=\"card\"><img class=\"card-img-top\"" +
...
marko_template.meta = {
    id: "/shop$1.0.0/server/views/productDetails.marko",
    tags: [
